...
public class OrgController {
    ...
    public RespBean editOrg(@RequestBody Org org){
        ...
        if (oldOrg != null) {
            if(!oldOrg.getPurchaseAdmin().isEmpty() && oldOrg.getPurchaseAdmin() != null){
            ...
            if(!oldOrg.getOrgAdmin().isEmpty() && oldOrg.getOrgAdmin() != null){
